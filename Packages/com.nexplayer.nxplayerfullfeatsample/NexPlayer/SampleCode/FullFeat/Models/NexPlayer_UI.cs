...
namespace NexPlayerSample
{
    public partial class NexPlayer
    {
        ...
        [SerializeField]
        public GameObject captionImage;
        [SerializeField]
        ...
        private void SetCaptionImageColor(Color color)
        {
            captionImage.GetComponent<Image>().color = color;
        }
        ...
        public void FillUI()
        {
            ...
            captionImage = GameObject.Find("NexButtons/CaptionToggle/captionImage");
