...
namespace NexPlayerSample
{
    ...
    public class NexPlayerEditor : Editor
    {
        ...
        SerializedProperty _captionGraphicProp;
        ...
        private void OnEnable()
        {
            ...
            _loopPlayProp = serializedObject.FindProperty(nameof(NexPlayer.loopPlay));
            ...
            _captionGraphicProp = serializedObject.FindProperty(nameof(NexPlayer.captionImage));
...
#region MEDIA SOURCE
        ...
        void DrawMediaPath()
        {
            ...
            if (_streamingTypeProp.intValue == 0)
            {
                ...
                {
                    EditorGUILayout.HelpBox("No URL, please specify  one", MessageType.Error);
                }
...
#region UI
        private void DrawUIReferences()
        {
            ...
            if (_showUI)
            {
                ...
                EditorGUILayout.PropertyField(_captionGraphicProp, new GUIContent("captionImage"), true);
